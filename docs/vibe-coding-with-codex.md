...
- [Chapter 03 - Turning Design Language Into Product Capabilities](vibe-coding-with-codex/en/03-turning-design-language-into-product-capabilities.md)
- [Chapter 04 - Defining The Front-End-Only Architecture](vibe-coding-with-codex/en/04-defining-the-front-end-only-architecture.md)
- [Chapter 05 - Designing The Data Model And Sample Company](vibe-coding-with-codex/en/05-designing-the-data-model-and-sample-company.md)
- [Chapter 06 - Making CSV Import Actually Work](vibe-coding-with-codex/en/06-making-csv-import-actually-work.md)
- [Chapter 07 - Building Real Drill-Down And Explainability](vibe-coding-with-codex/en/07-building-real-drill-down-and-explainability.md)
- [Chapter 08 - Testing, Validation, And Debugging With Codex](vibe-coding-with-codex/en/08-testing-validation-and-debugging-with-codex.md)
...
- Sample import file: `outputs/test-employee-map-import.csv`
